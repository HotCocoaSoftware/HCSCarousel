...

{
    ...
    AFImageCache * cache =  (AFImageCache *)typed_msgSend([self class], @selector(sharedImageCache));
    ...
    if (cachedImage) {
        ...
        id (*typed_msgSend)(id, SEL) = (void *)objc_msgSend;
        NSOperationQueue * operationQueue =  (NSOperationQueue *)typed_msgSend([self class], @selector(af_sharedImageRequestOperationQueue));
